...
function TennisScoreboard({
  ...
  // Static scoreboard data to use as fallback
  let staticData = {
    player1: "J. DOE",
    player2: "A. SMITH",
    score1: [0, 0, 0],
  ...
  const scoreboardData = liveData || staticData; // Use live data if available, otherwise fallback to static data
...
export default function Page() {
  return (
    <TennisScoreboard
      ...
      path="/tennis/stadium"
      apiKey="your_secure_api_key" // Pass the API key here
    />
  );
}
